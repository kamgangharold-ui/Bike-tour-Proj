...
// Returns a JSON string: the input stations array filtered to radiusMetres,
// sorted by distance ASC. Each record gains a distanceMetres integer field.
...
Future<String> filterParkingByDistance(
  ...
  for (final raw in stations) {
    ...
    results.add({...station, 'distanceMetres': distM.round()});
  }
